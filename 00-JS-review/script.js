...
const [ primaryGenre, secondryGenre ] = genres;
console.log(primaryGenre, secondryGenre);
...
const summary = `${title}, ${pages} pages long book, was written by ${author} and published in ${publicationDate.split("-")[0]}`;
summary

// 5.Ternaries Instead of ifelse Statement
...
const title1 = books.map((book) => book.title);
title1
...
const arr = [9, 3, 6, 1, 15, 11];
const sorted = arr.sort((a , b) => a - b);
sorted;

*/

const arr = [2, 20, 4, 18, 6, 16, 8, 14];
